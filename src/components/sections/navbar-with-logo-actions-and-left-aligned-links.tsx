...
export function NavbarLink({
  ...
  className,
  ...props
}: { href: string } & Omit<ComponentProps<typeof NextLink>, 'href'>) {
  return (
    <NextLink
      href={href}
      className={clsx(
...
export function NavbarLogo({ className, href, ...props }: { href: string } & Omit<ComponentProps<typeof NextLink>, 'href'>) {
  return <NextLink href={href} {...props} className={clsx('inline-flex items-stretch', className)} />
}
